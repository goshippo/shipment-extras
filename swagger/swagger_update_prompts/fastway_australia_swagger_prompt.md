# Swagger Update Prompt for Fastway Australia

## Overview
Update the swagger.yaml to accurately reflect the shipment extras supported by fastway_australia carrier service levels.

## Carrier: fastway_australia

## Service Levels Tested (5 total)
...
### Universal Extras (Supported by ALL 5 service levels)
- None
