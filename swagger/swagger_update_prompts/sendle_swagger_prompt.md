# Swagger Update Prompt for Sendle

## Overview
Update the swagger.yaml to accurately reflect the shipment extras supported by sendle carrier service levels.

## Carrier: sendle

## Service Levels Tested (2 total)
